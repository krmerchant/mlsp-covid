...
def construct_feature_matrix(superkeys, removedkeys, orderCombo):

    newkeys = list(superkeys - removedkeys) #now a list: these are the selected features
    newkeys.sort() #sort the list of keys
    ...
    print(f"ConstructFeatureMatrix.py Script runtime: {end_time - start_time:.2f} seconds")
    print(newkeys)
    #print(label1_data)
    ...
    return feature_data, label1_data, label2_data, newkeys, filenames, num_features, num_json_files